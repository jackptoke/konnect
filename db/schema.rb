...
ActiveRecord::Schema.define(version: 2019_10_28_003850) do
  ...
  create_table "interpreter_details", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["address_id"], name: "index_interpreter_details_on_address_id"
  ...
  add_foreign_key "interpreter_details", "addresses"
  add_foreign_key "interpreter_details", "interpreters"
end
